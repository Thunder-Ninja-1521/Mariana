...
! function(a) {
    ...
    function e(t) { setTimeout(function() { a(t).css({ opacity: a(t).data("fix-img-default-opacity") }) }, 1) }
    ...
    var l = {
        ...
        init: function(e, s) {
            ...
            for (var n = 0; n < d.length; n++) {
                ...
                if (u && o.wrapInner('<div id="imgfix_wrapper_layer_' + e.id + "_" + n + '" class="imgfix_wrapper_layer" style="position: relative; padding: 0; margin: 0; width: 100%; height: 100%; overflow: hidden;"></div>'), t(a("#imgfix_wrapper_layer_" + e.id + "_" + n + " .imgfix_src_img")[0]), u && a("#imgfix_wrapper_layer_" + e.id + "_" + n + " .imgfix_src_img").load(function() { t(this) }), o.data("fix-cover")) {
                    var h;
    ...
    a.fn.imgfix = function(t) {
        for (var e = -1, i = !1, s = 0; s < l.family.length; s++) { var r = !0; for (var f in this) this[f] != l.family[s].element[f] && (r = !1); if (r) { e = s, i = !0; break } }
        0 > e && (l.family.push(new Object), e = l.family.length - 1), l.family[e] = { id: e, element: this, parameters: t }, l.init(l.family[e], i), a(window).resize(function() { l.init(l.family[e], !0) })
